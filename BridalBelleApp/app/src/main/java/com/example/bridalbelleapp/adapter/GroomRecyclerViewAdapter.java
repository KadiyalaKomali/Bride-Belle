...
public class GroomRecyclerViewAdapter extends
        RecyclerView.Adapter<GroomRecyclerViewAdapter.MovieInfo> {
    int images[];
    String titles[];
    Context context;

    public GroomRecyclerViewAdapter(int[] images, String[] titles,Context context) {
        this.images = images;
        this.titles = titles;
